defmodule ThanthenbotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ThanthenbotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ThanthenbotWeb.Gettext, "errors", msg, opts)
    end
  end
